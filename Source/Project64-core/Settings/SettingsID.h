...
enum SettingID
{
    ...
    Setting_JfgTarget60Fps,
    Setting_JfgShowInputRate,
    Setting_JfgSchedulerRelease,
    Setting_JfgBoostViBudget,
    Setting_JfgFastCutscenes,
    Setting_JfgHalveEnemySpeed,
    Setting_JfgDroneInvertY,
    Setting_JfgDroneCameraDirect,
    Setting_JfgCrouchProneStickStrafe,
    Setting_JfgEnableSprint,
    ...
    FirstRSPDefaultSet,
    LastRSPDefaultSet = FirstRSPDefaultSet + MaxPluginSetting,
    FirstRSPSettings,
    LastRSPSettings = FirstRSPSettings + MaxPluginSetting,
    FirstGfxDefaultSet,
    LastGfxDefaultSet = FirstGfxDefaultSet + MaxPluginSetting,
    FirstGfxSettings,
    LastGfxSettings = FirstGfxSettings + MaxPluginSetting,
    FirstAudioDefaultSet,
    LastAudioDefaultSet = FirstAudioDefaultSet + MaxPluginSetting,
    FirstAudioSettings,
    LastAudioSettings = FirstAudioSettings + MaxPluginSetting,
    FirstCtrlDefaultSet,
    LastCtrlDefaultSet = FirstCtrlDefaultSet + MaxPluginSetting,
    FirstCtrlSettings,
    LastCtrlSettings = FirstCtrlSettings + MaxPluginSetting,
};
