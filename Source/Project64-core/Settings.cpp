...
void CSettings::AddHowToHandleSetting(const char * BaseDirectory)
{
    ...
    AddHandler(Setting_CurrentLanguage, new CSettingTypeApplication("Settings", "Current Language", "English"));
    ...
    AddHandler(Setting_JfgFastCutscenes, new CSettingTypeApplication("Game Specific Hacks", "JFG Fast Cutscenes", true));
    AddHandler(Setting_JfgHalveEnemySpeed, new CSettingTypeApplication("Game Specific Hacks", "JFG Halve Enemy Speed", true));
    AddHandler(Setting_JfgDroneInvertY, new CSettingTypeApplication("Game Specific Hacks", "JFG Drone Invert Y", true));
    ...
    AddHandler(Default_UseHleGfx, new CSettingTypeApplication("Defaults", "HLE GFX Default", false));
    ...
    AddHandler(RomList_GameDirInitial, new CSettingTypeRelativePath("Roms", ""));
    ...
    // Plugin
#ifdef _WIN32
    AddHandler(Plugin_RSP_Current, new CSettingTypeApplication("Plugin", "RSP Dll", "RSP\\Project64-ParallelRSP.dll"));
    AddHandler(Plugin_GFX_Default, new CSettingTypeApplication("Plugin", "Graphics Dll Default", "GFX\\Project64-ParallelRDP.dll"));
