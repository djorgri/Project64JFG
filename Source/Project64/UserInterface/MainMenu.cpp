    ...
    m_Gui(hMainWindow)
{
    ...
    m_ChangeSettingList.push_back(Setting_JfgKeyboardMouse);
    m_ChangeSettingList.push_back(Setting_JfgDroneLateralMovement);
    m_ChangeSettingList.push_back(Setting_JfgPreserveCameraInGameLimits);
    m_ChangeSettingList.push_back(Setting_JfgUncapFramePacing);
    m_ChangeSettingList.push_back(Setting_JfgTarget60Fps);
    m_ChangeSettingList.push_back(Setting_JfgShowInputRate);
    m_ChangeSettingList.push_back(Setting_JfgSchedulerRelease);
    m_ChangeSettingList.push_back(Setting_JfgBoostViBudget);
    m_ChangeSettingList.push_back(Setting_JfgFastCutscenes);
    m_ChangeSettingList.push_back(Setting_JfgHalveEnemySpeed);
    m_ChangeSettingList.push_back(Setting_JfgDroneInvertY);
    m_ChangeSettingList.push_back(Setting_JfgDroneCameraDirect);
    m_ChangeSettingList.push_back(Setting_JfgCrouchProneStickStrafe);
    m_ChangeSettingList.push_back(Setting_JfgEnableSprint);
    m_ChangeSettingList.push_back(Setting_JfgBoostViBudget30);
...
bool CMainMenu::ProcessMessage(HWND hWnd, DWORD /*FromAccelerator*/, DWORD MenuID)
{
    ...
    case ID_OPTIONS_DECREASE_SPEED:
        ...
        break;
    case ID_OPTIONS_GAME_SPECIFIC_HACKS:
        CGameSpecificHacksDialog().DoModal(hWnd);
        break;
    case ID_OPTIONS_JFG_KEYBOARD_MOUSE:
        g_Settings->SaveBool(Setting_JfgKeyboardMouse, !g_Settings->LoadBool(Setting_JfgKeyboardMouse));
        break;
    case ID_OPTIONS_JFG_LATERAL_MOVEMENT:
        g_Settings->SaveBool(Setting_JfgDroneLateralMovement, !g_Settings->LoadBool(Setting_JfgDroneLateralMovement));
        break;
    case ID_OPTIONS_JFG_PRESERVE_CAMERA_LIMITS:
        g_Settings->SaveBool(Setting_JfgPreserveCameraInGameLimits, !g_Settings->LoadBool(Setting_JfgPreserveCameraInGameLimits));
        break;
    case ID_OPTIONS_JFG_FREE_CAMERA_IN_JUMP:
        g_Settings->SaveBool(Setting_JfgFreeCameraInJump, !g_Settings->LoadBool(Setting_JfgFreeCameraInJump));
        break;
    case ID_OPTIONS_JFG_UNCAP_FRAME_PACING:
        g_Settings->SaveBool(Setting_JfgUncapFramePacing, !g_Settings->LoadBool(Setting_JfgUncapFramePacing));
        break;
    case ID_OPTIONS_JFG_TARGET_60FPS:
        g_Settings->SaveBool(Setting_JfgTarget60Fps, !g_Settings->LoadBool(Setting_JfgTarget60Fps));
        break;
    case ID_OPTIONS_JFG_SCHEDULER_RELEASE:
        g_Settings->SaveBool(Setting_JfgSchedulerRelease, !g_Settings->LoadBool(Setting_JfgSchedulerRelease));
        break;
    case ID_OPTIONS_JFG_BOOST_VI_BUDGET:
        g_Settings->SaveBool(Setting_JfgBoostViBudget, !g_Settings->LoadBool(Setting_JfgBoostViBudget));
        break;
    case ID_OPTIONS_JFG_FAST_CUTSCENES:
        g_Settings->SaveBool(Setting_JfgFastCutscenes, !g_Settings->LoadBool(Setting_JfgFastCutscenes));
        break;
    case ID_OPTIONS_JFG_HALVE_ENEMY_SPEED:
        g_Settings->SaveBool(Setting_JfgHalveEnemySpeed, !g_Settings->LoadBool(Setting_JfgHalveEnemySpeed));
        break;
    case ID_OPTIONS_JFG_DRONE_INVERT_Y:
        g_Settings->SaveBool(Setting_JfgDroneInvertY, !g_Settings->LoadBool(Setting_JfgDroneInvertY));
        break;
    case ID_OPTIONS_JFG_DRONE_CAMERA_DIRECT:
        g_Settings->SaveBool(Setting_JfgDroneCameraDirect, !g_Settings->LoadBool(Setting_JfgDroneCameraDirect));
        break;
    case ID_OPTIONS_JFG_CROUCH_PRONE_STICK:
        g_Settings->SaveBool(Setting_JfgCrouchProneStickStrafe, !g_Settings->LoadBool(Setting_JfgCrouchProneStickStrafe));
        break;
    case ID_OPTIONS_JFG_SHOW_INPUT_RATE:
        if (g_Settings->LoadBool(Setting_JfgShowInputRate))
        {
            g_Settings->SaveBool(Setting_JfgShowInputRate, false);
            g_Notify->DisplayMessage(0, EMPTY_STRING);
        }
        else
        {
            g_Settings->SaveBool(Setting_JfgShowInputRate, true);
        }
        break;
    ...
    case ID_CURRENT_SAVE_10:
        ...
        break;
    case ID_ABOUT: CAboutDlg().DoModal(); break;
    default:
...
void CMainMenu::FillOutMenu(HMENU hMenu)
{
    ...
    OptionMenu.push_back(MENU_ITEM(SPLITER));
    Item.Reset(ID_OPTIONS_GAME_SPECIFIC_HACKS, EMPTY_STRING, EMPTY_STDSTR, nullptr, L"Game-specific hacks...");
    OptionMenu.push_back(Item);
    OptionMenu.push_back(MENU_ITEM(SPLITER));
    ...
    Item.Reset(ID_ABOUT, MENU_ABOUT_PJ64);
    MainTitleMenu.push_back(Item);
