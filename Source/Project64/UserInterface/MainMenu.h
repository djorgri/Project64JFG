...
enum MainMenuID
{
    ...
    ID_OPTIONS_JFG_KEYBOARD_MOUSE,
    ID_OPTIONS_JFG_LATERAL_MOVEMENT,
    ID_OPTIONS_JFG_PRESERVE_CAMERA_LIMITS,
    ID_OPTIONS_JFG_FREE_CAMERA_IN_JUMP,
    ID_OPTIONS_JFG_UNCAP_FRAME_PACING,
    ID_OPTIONS_JFG_TARGET_60FPS,
    ID_OPTIONS_JFG_SCHEDULER_RELEASE,
    ID_OPTIONS_JFG_BOOST_VI_BUDGET,
    ID_OPTIONS_JFG_FAST_CUTSCENES,
    ID_OPTIONS_JFG_HALVE_ENEMY_SPEED,
    ID_OPTIONS_JFG_DRONE_INVERT_Y,
    ID_OPTIONS_JFG_DRONE_CAMERA_DIRECT,
    ID_OPTIONS_JFG_CROUCH_PRONE_STICK,
    ID_OPTIONS_JFG_SHOW_INPUT_RATE,
    ...
    ID_OPTIONS_GAME_SPECIFIC_HACKS = 4500,
};
